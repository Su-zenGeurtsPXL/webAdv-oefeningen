...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Stapel)\n/* harmony export */ });\n/* harmony import */ var _Dobbelsteen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Dobbelsteen */ \"./src/js/regenwormen/Dobbelsteen.js\");\n/* harmony import */ var _Selectie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Selectie */ \"./src/js/regenwormen/Selectie.js\");\n/* harmony import */ var core_js_internals_array_includes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/internals/array-includes */ \"./node_modules/core-js/internals/array-includes.js\");\n/* harmony import */ var core_js_internals_array_includes__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_internals_array_includes__WEBPACK_IMPORTED_MODULE_2__);\n // naam = Su-zen Geurts\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\n\nfunction _classPrivateFieldInitSpec(obj, privateMap, value) { _checkPrivateRedeclaration(obj, privateMap); privateMap.set(obj, value); }\n\nfunction _checkPrivateRedeclaration(obj, privateCollection) { if (privateCollection.has(obj)) { throw new TypeError(\"Cannot initialize the same private elements twice on an object\"); } }\n\nfunction _classPrivateFieldGet(receiver, privateMap) { var descriptor = _classExtractFieldDescriptor(receiver, privateMap, \"get\"); return _classApplyDescriptorGet(receiver, descriptor); }\n\nfunction _classApplyDescriptorGet(receiver, descriptor) { if (descriptor.get) { return descriptor.get.call(receiver); } return descriptor.value; }\n\nfunction _classPrivateFieldSet(receiver, privateMap, value) { var descriptor = _classExtractFieldDescriptor(receiver, privateMap, \"set\"); _classApplyDescriptorSet(receiver, descriptor, value); return value; }\n\nfunction _classExtractFieldDescriptor(receiver, privateMap, action) { if (!privateMap.has(receiver)) { throw new TypeError(\"attempted to \" + action + \" private field on non-instance\"); } return privateMap.get(receiver); }\n\nfunction _classApplyDescriptorSet(receiver, descriptor, value) { if (descriptor.set) { descriptor.set.call(receiver, value); } else { if (!descriptor.writable) { throw new TypeError(\"attempted to set read only private field\"); } descriptor.value = value; } }\n\n\n\n\n\nvar _selecties = /*#__PURE__*/new WeakMap();\n\nvar Stapel = /*#__PURE__*/function () {\n  function Stapel() {\n    _classCallCheck(this, Stapel);\n\n    _classPrivateFieldInitSpec(this, _selecties, {\n      writable: true,\n      value: void 0\n    });\n\n    _classPrivateFieldSet(this, _selecties, []);\n  }\n\n  _createClass(Stapel, [{\n    key: \"voegSelectieToe\",\n    value: function voegSelectieToe(selectie) {\n      if (!(selectie instanceof _Selectie__WEBPACK_IMPORTED_MODULE_1__[\"default\"])) {\n        throw new Error(\"Parameter is not a selectie\");\n      }\n\n      for (var i = 0; i < _classPrivateFieldGet(this, _selecties).length; i++) {\n        if (_classPrivateFieldGet(this, _selecties)[i].getDobbelsteen().getZijde() == selectie.getDobbelsteen().getZijde()) {\n          throw new Error(\"Selectie is already in Selecties\");\n        }\n      }\n\n      _classPrivateFieldGet(this, _selecties).push(selectie);\n    }\n  }, {\n    key: \"getNumeriekeWaarde\",\n    value: function getNumeriekeWaarde() {\n      var r = false;\n      var sum = 0;\n\n      for (var i = 0; i < _classPrivateFieldGet(this, _selecties).length; i++) {\n        sum += _classPrivateFieldGet(this, _selecties)[i].getNumeriekeWaarde();\n\n        if (_classPrivateFieldGet(this, _selecties)[i].getDobbelsteen().getZijde() == \"R\") {\n          r = true;\n        }\n      }\n\n      return r ? sum : 0;\n    }\n  }]);\n\n  return Stapel;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/regenwormen/Stapel.js?");
